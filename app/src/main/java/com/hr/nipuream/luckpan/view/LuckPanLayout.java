...
public class LuckPanLayout extends RelativeLayout {
    ...
    public LuckPanLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        screenWidth = getResources().getDisplayMetrics().widthPixels*9/10;
        startLuckLight();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int width = getWidth() - paddingLeft - paddingRight-15;
        int height = getHeight() - paddingTop - paddingBottom-15;
