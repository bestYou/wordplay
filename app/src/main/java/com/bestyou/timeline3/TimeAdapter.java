            ...
            if (position == 0) {
                if (data.size() >= 2) {
                    if (!timeData.getPosttime().equals(data.get(position + 1).getPosttime())) {
                        ...
                        layoutParams.setMargins(DensityUtil.dip2px(vLine.getContext(), 60), DensityUtil.dip2px(vLine.getContext(), 15), 0, 0);
                    } else {
                ...
                if (timeData.getPosttime().equals(data.get(position - 1).getPosttime())) {
                    if (timeData.getPosttime().equals(data.get(position + 1).getPosttime())) {
                        ...
                        layoutParams.setMargins(DensityUtil.dip2px(vLine.getContext(), 60), DensityUtil.dip2px(vLine.getContext(), 0), 0, 0);
