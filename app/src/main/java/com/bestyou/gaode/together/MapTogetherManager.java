package com.bestyou.gaode.together;
...
import com.bestyou.gaode.utils.DisplayUtil;
...
public class MapTogetherManager {
    ...
    private int CLUSTER_SIZE = 500;// 地图上距离小于多少个像素点,则合并
    private int DRAWABLE_RADIUS = 50;// 聚合网点的显示大小,drawable的radius大小
