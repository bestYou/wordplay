package com.bestyou.word.activity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.iv_crt4).setOnClickListener(this);
        findViewById(R.id.iv_geoword).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_crt4:
                intent.setClass(this, UnitListActivity.class);
                intent.putExtra(Const.META_KEY, Const.WORDS_CRT4);
                break;
            case R.id.iv_geoword:
                intent.setClass(this, UnitListActivity.class);
                intent.putExtra(Const.META_KEY, Const.WORDS_GEOWORD);
                break;
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Toast.makeText(this, "再按一次退出单词模块", Toast.LENGTH_SHORT).show();
